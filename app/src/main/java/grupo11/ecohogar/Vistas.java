...
public class Vistas extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,Bienvenido.OnFragmentInteractionListener,DatosVivienda.OnFragmentInteractionListener,DatosUsuario.OnFragmentInteractionListener, View.OnClickListener,ListaViviendas.OnFragmentInteractionListener {
    ImageButton casa;
    ImageButton nose;
    ImageButton energia;
    ImageButton agua;
    ...
    String IP = "http://proyectopractica.esy.es/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nose=(ImageButton)findViewById(R.id.imgbtnNose);
